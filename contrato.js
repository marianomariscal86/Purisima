...
function construirContratoHTML(d){
  ...
  <p>d) En caso de no pagar la totalidad en el plazo señalado, o de que haya un retraso en dos o más mensualidades, el saldo que exista en ese momento se financiará en 60 (sesenta) pagos mensuales consecutivos, con una tasa de interés variable equivalente a la Tasa de Interés Interbancaria de Equilibrio (TIIE) a 28 días publicada por el Banco de México, más 8 (ocho) puntos porcentuales sobre saldos insolutos. La tasa se ajustará mensualmente conforme a la publicación oficial de la TIIE. En caso de dejar de publicarse la TIIE, se aplicará la Tasa Sustituta definida en este contrato. El Primer Pago será el primer día del mes siguiente al término del plazo de los 365 días, y el último pago se realizará al cumplimiento de los 60 meses.</p>` : `
